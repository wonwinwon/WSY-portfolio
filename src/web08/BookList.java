    ...
    public BookList() {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
                ...
                try {
                        ...
                        String sql2="select room_name,howmuch,howmany1 from room where room_type='"+rooms+"' and room_id in"
                        ...
                        while(rs.next() && rs2.next()) {
                                ...
                                jo.put("howmuch", rs2.getString("howmuch"));
                                jo.put("howmany1",rs2.getString("howmany1"));
